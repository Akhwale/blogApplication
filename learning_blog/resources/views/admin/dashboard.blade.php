     ...
     <div class="d-flex p-4 justify-content-between ">
       ...
       <div class="card bg-success" style="width: 16rem;">
         <div class="card-body text-center">
           ...
           <a href="#" class="btn btn-warning text-light"  >View Posts</a>
         </div>
       </div>
       ...
       <div class="card bg-primary" style="width: 16rem;">
        <div class="card-body text-center">
          ...
          <h1 class="card-text text-dark"> {{ $totalusers }} </h1>
          <a href="#" class="btn btn-warning text-light"  >View Users</a>
        </div>
      </div>
       ...
       <div class="card bg-danger" style="width: 30rem;">
        <div class="card-body text-center">
          ...
          <a href="#" class="btn btn-warning text-light">Blog Page</a>
        </div>
      </div>
     </div>
     </div>
